    ...
    <div className='min-h-screen bg-transparent flex flex-col items-center justify-center relative overflow-hidden gap-6 loading-spinner-wrapper'>
      <div className="sf-search-loader">
        <div className="sf-search-loader-container">
          {/* Box logo */}
          <PiCodesandboxLogoFill className="text-white text-5xl" />

          {/* Modified search icon with white color */}
          <motion.svg
          ...
          >
            <circle strokeWidth="7" stroke="white" cx="45" cy="45" r="25"></circle>
            <line strokeWidth="7" stroke="white" x1="65" y1="65" x2="90" y2="90"></line>
          </motion.svg>
        </div>
        <div className="sf-loading-text text-white">Searching for Stocks...</div>
      </div>
    </div>
  );
};
